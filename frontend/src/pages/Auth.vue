...
onBeforeMount(() => {
  ...
  if (route.query.hash) mode.value = 'signUp'
})
  ...
  <div class="auth">
    <div class="wrapper">
      <div class="wrapper-body">
        ...
        <pre>If you have lost access to the website, please go to the <a class="tat-frame"
        :href="env === 'production' ? 'https://discord.gg/VT6grnfD6t' : 'https://discord.gg/rD9bgctHNr'">authentication</a> channel in Discord and type the command '/reset'.</pre>
        ...
        <el-button @click="mode = 'signIn'" v-if="mode === 'signUp'" link
          >Already have account</el-button
        >
      </div>
    </div>
  </div>
